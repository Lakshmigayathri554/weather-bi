...
const setWeatherDetails = (data) => {
    ...
    switch (data.weather[0].main) {
        case 'Clouds':
            weatherIcon.src = "p/Clouds.png";
            break;
        case 'Clear':
            weatherIcon.src = "p/sun.png";
            break;
        case 'Rain':
            weatherIcon.src = "p/rainy.png";
            break;
        case 'Mist':
            weatherIcon.src = "p/mist.png";
            break;
        case 'Snow':
            weatherIcon.src = "p/snow.png";
            break;
        case 'Haze':
            weatherIcon.src = "p/haze.png";
            break;
    }
}
